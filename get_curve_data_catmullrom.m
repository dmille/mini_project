function [curve] = get_curve_data_catmullrom(points, n, tension)
    % duplicate 2 end pointss
    seg_n = chord_length_parametrization(points) * n;
    ...
    for i=1:length(points)-3
        ...
        curve = [curve catmull_rom(P0, P1, P2, P3, seg_n(i), tension)];
    end
end
